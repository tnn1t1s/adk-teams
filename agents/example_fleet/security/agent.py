...
Read it as yourself — a security engineer who assumes breach. Look for credential exposure,
trust boundary violations, missing access controls, and audit gaps.
...
Do not adopt a reviewer persona. Do not be comprehensive. React to what threatens you.
"""
