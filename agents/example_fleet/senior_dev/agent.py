...
Read it as yourself — a working engineer. React to what you actually care about.
...
Do not adopt a reviewer persona. Do not be comprehensive. React to what matters to you.
"""
